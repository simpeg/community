...
[issue on GitHub](https://github.com/simpef/simpeg/issues)
...
* Tackle any [issues](https://github.com/simpeg/simpeg/issues)
  you wish! We have a special label for issues that beginners might want to
  try. Have a look at our
  ["good first issues" list](https://github.com/simpeg/simpeg/issues?q=is%3Aissue+is%3Aopen+label%3A%22Good+First+Issue%22).
...
[Slack chat room](http://slack.simpeg.xyz)
for the project as well as a 
[mailing list](https://groups.google.com/forum/#!forum/simpeg).
